package com.example.sourabh.map;
...
//        polylinePath = null;
  ...
  public void loadMap(File areaFolder)
  {
    ...
    mapView.map().setMapPosition(28.710368, 77.078777, 1 << 12);
...
//      Drawable drawable = activity.getDrawable(resource); // Since API21
    ...
    public void startTrack() {
        ...
        polylineTrack = updatePathLayer(polylineTrack, trackingPointList, 0xff0000, 4);
    ...
    public void addTrackPoint(GeoPoint point) {
      ...
      updatePathLayer(polylineTrack, trackingPointList, 0xff0000, 4);
      mapView.map().updateMap(true);
    }
        ...
        new AsyncTask<Void, Void, GHResponse>() {
            ...
            protected void onPostExecute(GHResponse ghResp) {
                if (!ghResp.hasErrors()) {
                    ...
                    int sWidth = 4;
                    pathLayer = updatePathLayer(pathLayer, resp.getPoints(), 0xff1EA2DC, sWidth);
                    mapView.map().updateMap(true);
