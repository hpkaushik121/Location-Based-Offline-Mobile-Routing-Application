...
import com.example.sourabh.fragments.AppSettings;
import com.example.sourabh.map.Destination;
import com.example.sourabh.model.SportCategory;
import com.example.sourabh.model.listeners.MapHandlerListener;
import com.example.sourabh.model.listeners.NavigatorListener;
import com.example.sourabh.model.listeners.OnClickAddressListener;
import com.example.sourabh.navigator.NaviEngine;
import com.example.sourabh.map.MapHandler;
import com.example.sourabh.map.Navigator;
import com.example.sourabh.fragments.InstructionAdapter;
import com.example.sourabh.fragments.SpinnerAdapter;
import com.example.sourabh.util.Calorie;
import com.example.sourabh.util.MyUtility;
        ...
        controlBtn.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                if (isMenuVisible()) {
                    ...
                    controlBtn.setImageResource(R.drawable.ic_keyboard_arrow_left_white_24dp);
